            ...
            <div className='mt-6'>
              {dockerApiStatus ? (
                <>
                  ...
                  will be able to monitor the services in JIO
                </>
              ) : (
                <>
                  It appears docker is not running locally. You still we be able
                  to install docker on this machine. But you will not be able to
